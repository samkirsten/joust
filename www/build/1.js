...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__game_hosted__ = __webpack_require__(331);
...
var GameHostedPage = (function () {
    ...
    GameHostedPage.prototype.sendMessage = function () {
        this.socket.emit('add-message', { text: this.message });
        this.message = '';
    };
    GameHostedPage.prototype.getMessages = function () {
        var _this = this;
